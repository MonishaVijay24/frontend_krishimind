  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1.1fr", gap: 11 }}>
      ...
      <div style={{ ...cardStyle({ padding: "16px 18px", position: "relative", overflow: "hidden" }) }}>
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: G.faint }} />
        <div style={{
        ...
        <div style={{
          ...
          ₹{cdata.base}<span style={{
            fontSize: 15, color: G.muted, fontFamily: "'Mukta',sans-serif",
            fontWeight: 600
          }}>/kg</span>
        </div>
        <div style={{ fontSize: 13, color: G.muted, marginTop: 5, fontWeight: 600 }}>₹{cdata.base * 100}/Q · Agmarknet</div>
      </div>
      ...
      <div style={{ ...cardStyle({ padding: "16px 18px", position: "relative", overflow: "hidden" }) }}>
        ...
        <div style={{
          fontSize: 12, color: G.muted, fontWeight: 700, textTransform: "uppercase",
          letterSpacing: "0.1em", marginBottom: 6
        }}>🔮 Predicted D{days}</div>
        <div style={{
          fontFamily: "'Playfair Display',serif", fontSize: 34, fontWeight: 700,
          color: G.green, lineHeight: 1
        }}>
          ₹{cdata.pred}<span style={{
            fontSize: 15, color: G.muted, fontFamily: "'Mukta',sans-serif",
            fontWeight: 600
          }}>/kg</span>
        </div>
        <div style={{ fontSize: 13, fontWeight: 700, color: cdata.pct > 0 ? G.green : G.red, marginTop: 5 }}>
          {cdata.pct > 0 ? "▲" : "▼"}{Math.abs(cdata.pct)}% · LSTM
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          position: "absolute", top: 0, left: 0, right: 0, height: 3,
          background: `linear-gradient(90deg,${cdata.conf >= 75 ? G.green : G.amber},#2D9E58)`
        }} />
        ...
        <div>
          ...
          <div style={{ fontSize: 13, color: G.muted, marginTop: 1, fontWeight: 600 }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,0.85)", lineHeight: 1.5 }}>
          {isHold
            ? `+${cdata.pct}% over ${days}d · Wait D${Math.round(days * 0.75)}`
